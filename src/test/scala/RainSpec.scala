...
class RainSpec extends WordSpec with MustMatchers {
  ...
  "mean" must {
    ...
    "return 51.199999999999996 when given town of 'London'" in {
      Rain.mean("London", data) mustEqual 51.199999999999996
    }

    "return 126.8 when given town of 'Tokyo'" in {
      Rain.mean("Tokyo", data) mustEqual 126.8
    }

    "return -1 when given town of 'Newcastle'" in {
      Rain.mean("Newcastle", data) mustEqual -1
    }
  }
  ...
  "variance" must {
    ...
    "return 57.428333333333335 when given town of 'London'" in {
      Rain.variance("London", data) mustEqual 57.428333333333335
    }

    "return 2619.256666666667 when given town of 'Tokyo'" in {
      Rain.variance("Tokyo", data) mustEqual 2619.256666666667
    }

    "return -1 when given town of 'Newcastle'" in {
      Rain.variance("Newcastle", data) mustEqual -1
    }
  }
}
